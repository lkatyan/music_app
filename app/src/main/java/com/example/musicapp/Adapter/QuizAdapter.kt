...
import com.example.musicapp.Activity.Quiz.GameActivity
import com.example.musicapp.Activity.Quiz.TestActivity
import com.example.musicapp.Domain.ListItem
import com.example.musicapp.R

class QuizAdapter (listArray: ArrayList<ListItem>, context: Context):
    ...
    class ViewHolder(view: View): RecyclerView.ViewHolder(view) {
        ...
        fun bind(listItem: ListItem, context: Context) {
            ...
            itemView.setOnClickListener() {
                if (title.text.toString() == "Узнай по фото") {
    ...
    fun updateQuizAdapter(listArray: List<ListItem>) {
        listArr.clear()
