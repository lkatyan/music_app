...
import com.example.musicapp.Adapter.QuizAdapter
...
//        list.addAll(fillArray("", resources.getStringArray(R.array.test_one),
//            resources.getStringArray(R.array.test_two),
//            getImageId(R.array.test_three)))

        adapter = QuizAdapter(list, this)
        recycler_view.adapter = adapter

        adapter?.updateQuizAdapter(fillArray("", resources.getStringArray(R.array.test_one),
            resources.getStringArray(R.array.test_two),
            getImageId(R.array.test_three)))
    }
